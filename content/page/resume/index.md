---
title: Resume For Meek
description: Quick Resume for Meek
date: '2024-11-10'
aliases:
  - resume
lastmod: '2024-12-21'
...
# Skillset
|          Skillset         | Years of Experience |
|---------------------------|---------------------|
| Java Programming Language |       11 Years      |
| Spring Framework          |       11 Years      |
| Linux Server Admin        |       11 Years      |
| JUnit Framework           |       11 Years      |
| Azure DevOps              |        3 Years      |
| Mulesoft Integration      |        1 Year       |
...
- Speciality Chemcials Company
  - Developed a custom React/Spring Boot application to handle Occupational Safety checklist process
  - Included internationalization for Portuguese

## The Home Depot - Staff Software Engineer - Feburary 2021 - July 2021
- Architected a replacement for a legacy offline sales tax system using Apache CouchDB as the data store
- Selected by 2021 DevNexus Conference commitee [(Conference video)](https://youtu.be/OKaKdo4U9r8) to present migrating from JUnit 4 to JUnit 5 Best Practices

## The Home Depot - Senior Software Engineer - May 2019 - June 2020
- Team Lead on the common sales taxation API, key wins for said team:
  - The migration of Homedepot.com to said API
  - Resolving a complex tax process around furnished installs

## The Home Depot - Contractor (Brooksource) - January 2019 - May 2019
- Developer on the common sales taxation API, which used Spring Framework and Java

## AT&T - Professional Application Developer - July 2017 - January 2019
- Team Lead of a cross-office group with the task of providing full-service Continuous Integration/Continuous Delivery (CI/CD) solutions to application teams

- Lead Software Architect of a business partner ticketing system designed to allow business partners to request enhancements to their custom solution
...
- Developed Web Service Interfaces that communicate using XML messages via SOAP web services using Java 7 EE, Spring Framework and Hibernate JPA.
...
- Provided opinion and insight to the development of a lab-wide Quality Assurance process for using the Git distributed source code repository system.

## King & Spalding LLP – Service Desk Technician – June 2007 – April 2010
### _Business Litigation Law Firm – 9 corporate offices around the world as of 2010_
